 ...
 *   2. Активное авто
 *   3. Мой гараж
 *   4. Промо-баннер «акция месяца» с обратным отсчётом
 *   5. Предстоящие визиты (если есть активные записи)
 *   6. История обслуживания (если есть завершённые)
 *
 * Порядок 1–3 — правка заказчика от 01.09 (эскиз «Главная» + голосовое):
 * «пусть сначала идёт блок «ваш автомобиль готов к сервису», потом активное
 * авто, потом мой гараж, потом история». Раньше гараж стоял колонкой справа
 * от hero, то есть визуально ВЫШЕ активного авто.
 *
