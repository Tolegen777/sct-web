 ...
 *   Главная / Авто / Услуги / Контакты
 *
 * «Авто» (сервисная книжка) требует авторизации — для гостя пункт
...
type IconName = 'home' | 'car' | 'service' | 'mail'
...
const TABS: Tab[] = [
  ...
  { to: '/service-book', label: 'Авто', icon: 'car', authOnly: true },
...
function TabIcon({ name, active }: { name: IconName; active: boolean }) {
  ...
  return (
    ...
    >
      ...
      {name === 'car' && (
        <>
          <path d="M5 17h-1a1 1 0 01-1-1v-3.2c0-.4.1-.7.3-1l1.9-3.4A2 2 0 017 7.3h6.6c.5 0 1 .2 1.4.5L17.5 10s2.4.5 3.9.9c.7.2 1.1.8 1.1 1.5V16a1 1 0 01-1 1h-2" />
          <path d="M9 17h6" />
